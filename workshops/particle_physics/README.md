...
In physics, `G` refers to the [Gravitational Constant](https://simple.wikipedia.org/wiki/Gravitational_constant), which is 6.67 x 10<sup>-11</sup> (6.67e-11) N⋅m<sup>2</sup>⋅kg<sup>-2</sup>. This constant is used as the basis for all sorts of fun equations.
