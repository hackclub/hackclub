...
Now let's use JavaScript to make the sky change colors.
...
Let's make some sounds. We'll use a tool called [Howler](https://github.com/goldfire/howler.js#documentation), which makes it really simple to work with sound in JavaScript.
