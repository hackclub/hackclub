...
If you want to customize the color, you can use W3School's [HTML Color Picker](https://www.w3schools.com/colors/colors_picker.asp) to get the `hexadecimal` value of whatever color you want.
