...
![bigfoot image](img/bigfoot_image.png)
...
![popup when you click on bigfoot](img/bigfoot_popup.gif)
...
> ![google search result for "html handle click"](img/google_html_handle_click.png)

Clicking the first link takes you [here](http://www.w3schools.com/jsref/event_onclick.asp):

> ![w3schools onclick article](img/w3schools_onclick.png)
...
> ![google search result for javascript popup box](img/google_javascript_popup_box.png)

The first link takes you [here](http://www.w3schools.com/js/js_popup.asp):

> ![w3schools on popup](img/w3schools_popup.png)
...
![background of our bigfoot](img/bigfoot_background.png)
...
![position of bigfoot](img/bigfoot_position.png)
...
> ![search result for html position](img/google_html_position.png)

The first link takes you [here](http://www.w3schools.com/cssref/pr_class_position.asp):

> ![w3schools position](img/w3schools_position.png)
