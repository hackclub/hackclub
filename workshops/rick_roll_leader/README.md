...
![Creating customer journeys through conversations. Engaging experiences that move with your customers. Try it free. Contact Sales.](https://cdn.hackclub.com/rescue?url=https://cloud-1voihokpp-hack-club-bot.vercel.app/6nexmo.png)

Visit [Nexmo's website](https://nexmo.com) and sign up by clicking on "Try it free".

![Sign up up form with fields for name, email, and password](https://cdn.hackclub.com/rescue?url=https://cloud-94wpook6x-hack-club-bot.vercel.app/2signup.png)

Fill out the signup form with the requested information.

![Verification letter asking to verify your email](https://cdn.hackclub.com/rescue?url=https://cloud-1voihokpp-hack-club-bot.vercel.app/4email-verify-email.png)
...
![Request message for phone number verification](https://cdn.hackclub.com/rescue?url=https://cloud-94wpook6x-hack-club-bot.vercel.app/0phone-verification.png)
...
![Dashboard showing API keys and account balance](https://cdn.hackclub.com/rescue?url=https://cloud-1voihokpp-hack-club-bot.vercel.app/2dashboard.png)
...
![Webpage prompting user to name the new application](https://cdn.hackclub.com/rescue?url=https://cloud-94wpook6x-hack-club-bot.vercel.app/3voice.png)
...
![Data table for creating a new virtual phone number](https://cdn.hackclub.com/rescue?url=https://cloud-1voihokpp-hack-club-bot.vercel.app/7number.png)
