---
name: Flappy bird
description: Make a flappy bird clone using p5.js
author: '@KhushrajRathod'
---

# Flappy Bird

Today, we're going to be building a flappy bird clone

Here's the [final code](https://z.khushrajrathod.com/ls) and [live demo](https://z.khushrajrathod.com/ls).

If you get stuck anywhere in this workshop, feel free to ask me questions! I'm @KhushrajRathod on the [Hack Club Slack](https://z.khushrajrathod.com/ls).
