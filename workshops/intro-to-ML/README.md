...
# Machine Learning
Machine learning is very similar to Artificial Intelligence but it is not exactly it. Machine learnig (or ML as it is called) is about data and classification.  
...
It will repeat this for a number of "EPOCHS" which we will see shortly. But first, here's how we tell it to use 'MEAN SQUARED ERROR' for the loss and 'STOCHASTIC GRADIENT DESCENT' for the optimizer. We don't need to understand the math for these yet, but we can see that they work! :)   
