...
This workshop is an introduction to [React.js](https://reactjs.org) using [Next.js](https://nextjs.org). It assumes you have some familiarity with HTML and JavaScript, but you should be able to follow along. We’ll also assume some familiarity with programming concepts like functions, objects, arrays, and classes, but if you don’t know what those are, just try to follow along.
