...
- It should look like this:
  ...
  ![Cloud9 dashboard](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/2cloud9_dashboard.png)

2. Create a workspace!

- Press the **create a new workspace** button.

  ![create new workspace](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/3create_new_workspace.gif)
...
- For the template you may choose either **Custom** or **HTML5**.
  ...
  ![name new workshop](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/4name_new_workshop.gif)
...
- Close the opened `README.md` as well.
  ...
  ![close readme](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/1close_readme.gif)
...
- You may press <kbd>Ctrl+S</kbd> (Windows), <kbd>Cmd+S</kbd> (Mac) or go to File --> Save.
  ...
  ![save in Cloud9](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/6save_in_cloud9.gif)
...
- Git enables many people to work separately on the same project
  ...
  ![Git status](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/6git_status.png)
...
- Git treats every version of code as a **"snapshot"** that you can look **back/
  ...
  - Running a command called `git log` in the terminal displays every change
    ...
    ![Git log](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/9git_log.png)
...
![example branches](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/6example_branches.png)
...
![feature branch tree](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/7feature_branch_tree.png)
...
![clone from git into Cloud9](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/0clone_from_git_in_cloud9.png)
...
- Hit the "+" button in the bottom panel area OR on the top-bar click
  ...
  ![open new terminal](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/5new_terminal.gif)
...
- My only file is `index.html`.
  ...
  ![git add .](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/0git_add.gif)
...
- Don't make bad commit messages: be concise, but clear about what you did.
  ...
  - Bad message example:
    ...
    ![](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/8bad_commit_message.png)

  - Good message example:

    ![](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/7good_commit_message.png)

  ![git commit](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/1git_commit.gif)
...
![GitHub username](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/2github_username.png)

- The characters for the password not show up in the terminal for security
  reasons — just keep typing!

![git push password](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/4git_push_password.gif)
...
- It might take about 30 seconds to fully get online.
  ...
  ![git push to `gh-pages`](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/3git_push_gh-pages.gif)
...
![Git (6) God](https://cdn.hackclub.com/rescue?url=https://cloud-9i6mz70ob-hack-club-bot.vercel.app/0LWvdiqA.gif)
...
- Hit the "+" button in the bottom panel area OR on the top-bar click
  ...
  ![new terminal in Cloud9](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/5new_terminal.gif)
...
![`git init`](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/2git_init.gif)
...
- It will be something similar looking to:
  ...
  ![create a repo on GitHub](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/7github_create_repo.gif)
...
- [remote-name] is where you name your remote.
  ...
  ![git remote add](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/5git_remote_add.gif)
...
- Think of committing as packaging something into a package and putting the
  shipping label on it.
- Don't make bad commit messages: be concise, but clear about what you did.
  ![Bad message example](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/8bad_commit_message.png)
  ![Good message example](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/7good_commit_message.png)
  ![git commit](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/1git_commit.gif)
...
- After hitting enter, you need to sign with your **GitHub credentials**.
  ...
  ![enter password git push](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/4git_push_password.gif)
...
![Drake clapping](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/5drake_clapping.gif)
...
![git clone](https://cdn.hackclub.com/rescue?url=https://cloud-d76jv25xw-hack-club-bot.vercel.app/8git_clone.png)

You'll find the **`[repo-url]`** when you click a into a repo on GitHub and look
for this:

![clone URL](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/9clone_url.png)
...
![create pull request](https://cdn.hackclub.com/rescue?url=https://cloud-i0dmikcsu-hack-club-bot.vercel.app/4create_pull_request.gif)

A good Git workflow:

![good git workflow](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/3good_git_workflow.png)
...
![GitHub fork button](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/0github_fork_button.png)
...
![GitHub issues tab](https://cdn.hackclub.com/rescue?url=https://cloud-9bugzpkc4-hack-club-bot.vercel.app/1github_issues_tab.png)
