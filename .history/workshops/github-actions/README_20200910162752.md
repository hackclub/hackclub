...
1. This action is triggered when there is a *pull request on the master branch*. The event which triggers the action is mentioned under `on:`.
2. An action has one or more `jobs`. The first does the following:
...
![greencheck img](github-actions/img/../../img/greencheck.png)
...
![secret img](github-actions/img/../../img/secret.png)
