...
- We had a new advisor, as our main advisor couldn't be with us on Wednesdays,
  so we now have 2 advisors, one for Monday and the other for Wednesday.
- We started with the
...
- Then we decided to have some fun since our advisor wasn't there, we talked
  about a website that was created in hackingEDU. We went into
  (http://www.getwiththe.club/). Then our advisor was coming into the room,
  so we stopped.
...
- We needed to explain more about the club to the advisor.
